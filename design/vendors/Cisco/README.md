...
1) It is the next generation of hardware (now 1 year old with [ambitious plans]()), comparable or better to the regular compute blades; M4 and M5 can be mixed, can add compute blades as well
